...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/Komorebi-interfaz/userAdmin/webroot/css/style.css" />
    <script src="https://kit.fontawesome.com/a8bf13818c.js" crossorigin="anonymous"></script>
    <!-- tablas perfil css, es necesario para que cojan los estilos de las tablas -->
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.4/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    <!-- fin tablas perfl css  -->
  </head>
  <body>
    <div class="container">
      ...
      <div class="container2">
        <aside>
          ...
          <p>Name user</p>
          <ul>
            <li  onclick="transition(1)"  class="perfil">Perfil</li>
            ...
            <a href="../index/index.html">Salir</a>
          </ul>
        </aside>
        <!-- perfil -->
        <section id="perfil">
    ...
    <!-- Segir comprando -->
      <div class="cuadro-seguir" id="cuadro-seguir">
        ...
        <div>
          <button type="submit" class="btn-seguir"><a href="../index/index.html">Seguir Comprando</a></button>
        </div>
      </div>
      <!-- donde te encuentras -->
