            ...
            <div class="contenedor__todo">
                <div class="caja__trasera">
                    <div class="caja__trasera-login">
                        ...
                        <a href="../../../panel-admin/includes/sesion/login.php "><button id="btn__iniciar-sesion">Sesión Admin</button></a>
                ...
                <div class="contenedor__login-register">
                    <!--Login-->
                    <form action="prueba.php" class="formulario__login" id="form" method="post">
                        <a href="../../../index/index.php"><img src="../../assets/imagenes/logo rojo.png" alt="Iniciar Sección"></a>
                        <input type="text" placeholder="Usuario" name="email">
                        <input type="password" placeholder="Contraseña" name="pass">
                        <button type="submit">Enviar</button>
                        <a href="../../formRecuperar.php">¿Olvidaste tu contraseña?</a>
                    </form>
